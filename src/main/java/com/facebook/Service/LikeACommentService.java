...
import com.facebook.Repositories.LikeACommentRepository;
...
public class LikeACommentService {

    private final LikeACommentRepository likeACommentRepository;
    ...
    public void likeComment(UUID commentId, String email){
        ...
        boolean alreadyLiked = likeACommentRepository.findAllByUserAndComment(user,comment).isPresent();
        ...
        likeACommentRepository.save(like);
    ...
    public void removeLike(UUID commentId, String email){
        ...
        LikeAComment likeAComment = likeACommentRepository.findAllByUserAndComment(user, comment)
                .orElseThrow(() -> new RuntimeException("You haven't liked this comment"));

        likeACommentRepository.delete(likeAComment);
